...
namespace Sopra.Logic.Items
{
    ...
    [Serializable]
    public sealed class ItemLasergun3 : Item
    {
        ...
        private ItemLasergun3() { }

        internal ItemLasergun3(OffsetType offsetType = OffsetType.Player)
            : base("lasergun", "items/icons/lasergun3_icon", 500, 2000, true, 3)
        {
