...
namespace Sopra.Logic.Items
{
    ...
    [Serializable]
    public sealed class ItemLasergun : Item
    {
        ...
        private ItemLasergun() { }

        internal ItemLasergun(OffsetType offsetType = OffsetType.Player)
            : base("lasergun", "items/icons/lasergun1_icon", 500, 2000, true,1)
        {
