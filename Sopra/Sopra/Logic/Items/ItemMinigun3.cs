...
{
    [Serializable]
    public sealed class ItemMinigun3 : Item
    {
        ...
        private ItemMinigun3()
            : this(OffsetType.Player)
        {
        }

        internal ItemMinigun3(OffsetType offsetType = OffsetType.Player)
            : base("minigun", "items/icons/minigun3_icon", 200, 10000, true, 3)
        {
