...
namespace Sopra.Screens.MenuScreens
{
    ...
    public class PauseMenu : AbstractScreen, IInitializable
    {
        ...
        public PauseMenu(MenuActions menuActions, ContentManager content, SpriteBatch batch, LevelManager levelManager, GameTime gameTime)
            : base(true, false)
        {
        ...
        private void CreateButtons()
        {
            ...
            var speichernBtnTe = mContent.Load<Texture2D>("graphics/pause/button_spiel-speichern");
            ...
            mSpeichernBtn = new Button(new Rectangle(280, 410, 240, 60), speichernBtnTe, mFont);
            mBeendenBtn = new Button(new Rectangle(280, 480, 240, 60), beendenBtnTe, mFont);
        }
        ...
        private void Actions()
        {
            ...
            // mOptionenBtn.mOnClick = () => mMenuActions.YouWon();
            mSpeichernBtn.mOnClick = IfSaveState;
        ...
        public override void Draw(SpriteBatch spriteBatch)
        {
            ...
            mSpeichernBtn.Draw(spriteBatch);
