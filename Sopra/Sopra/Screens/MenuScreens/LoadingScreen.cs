...
namespace Sopra.Screens.MenuScreens
{
    ...
    public class LoadingScreen : AbstractScreen, IInitializable

    {
        ...
        public LoadingScreen(MenuActions menuActions, ContentManager content, SpriteBatch batch)
        {
            mContent = content;
            mSpriteBatch = batch;
        ...
        private void Actions()
        {
            ...
            mZurueckBtn.mOnClick = () => mMenuActions.GoBackFromLoading();
        }
