...
namespace Sopra.Engine.Screen.Screens
{
    ...
    class Menu : AbstractScreen
    {
        ...
        public Action mOnClickStartBtn;
        public Action mOnClickOptionsBtn;
        public Action mOnClickBeendenBtn;
        ...
        public Menu(ContentManager content)
        {
            ...
            mStartBtn.mOnClick = () => mOnClickStartBtn?.Invoke();
            mOptionsBtn.mOnClick = () => mOnClickOptionsBtn?.Invoke();
            mBeendenBtn.mOnClick = () => mOnClickBeendenBtn?.Invoke();
        }
